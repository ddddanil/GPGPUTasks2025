...
void merge_sort_fine(const gpu::WorkSize &workSize, gpu::gpu_mem_32u const& input_data, gpu::gpu_mem_32u & output_data, gpu::gpu_mem_32u const& input_windows, int sorted_k, int n);
}
